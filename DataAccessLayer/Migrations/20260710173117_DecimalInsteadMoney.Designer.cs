...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20260710173117_DecimalInsteadMoney")]
    partial class DecimalInsteadMoney
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.Employee", b =>
                {
                    ...
                    b.HasIndex(new[] { "PersonellNumber" }, "UQ__employee_personell_number")
                        .IsUnique();

                    b.HasIndex(new[] { "PhoneNumber" }, "UQ__employee_phone_number")
                        .IsUnique();
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.Passport", b =>
                {
                    ...
                    b.HasIndex(new[] { "Number" }, "UQ__passport_number")
                        .IsUnique();
